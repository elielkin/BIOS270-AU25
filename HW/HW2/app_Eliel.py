...
st.image(
    "https://github.com/elielkin/BIOS270-AU25/blob/de4ab26186dd4ff6dbf400aac0b8aa299128dd08/ImageFolders/HW2/attention_PafA.png",
    width=150
)
    ...
    if not (seqA and seqB):
        ...
        try:
            ...
            if len(vals) > 0:
                ...
                fig2 = px.histogram(vals, nbins=10, title="Distribution of Match Values (Match=1, Mismatch=0)")
